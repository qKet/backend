...
public interface ReviewService {
    ReviewDTO write(Long performanceId, Long roundId, String userId, String content, int rating, String clientIp);
    List<ReviewDTO> list(Long performanceId);
    List<ReservationDTO> reviewableRounds(Long performanceId, String userId);
    ReviewDTO update(Long reviewId, String userId, String content, int rating, String clientIp);
