...
-- PERFORMANCE_ROUND
-- [로컬 테스트 편의] open_time = round_time 당일 오전 10시로 맞춤 (2026-08-13에 예매 오픈 알림
-- 기능 테스트하려고 바꿈 — 예전엔 전부 2025-01-01로 박아둬서 무조건 예매 가능했는데, 그러면
-- "아직 오픈 안 한 회차"가 하나도 없어서 오픈 알림 버튼이 절대 안 보였음. 이미 지난 회차는
-- 당일도 어차피 과거라 여전히 즉시 예매 가능 — 결제 플로우 테스트엔 영향 없음. 아직 안 지난
-- 회차(예: 8/27 이후)만 "당일 오전 10시 전까진 예매 안 열림"으로 바뀜)
...
INSERT INTO PERFORMANCE_ROUND (performance_id, round_time, open_time, round_status, ins_id, ins_ip) VALUES
  ...
  (2, '2026-09-02 19:00:00', '2026-09-02 10:00:00', 'OPEN', 'admin01', '127.0.0.1'),
  -- BLACKPINK (venue=4)
  (3, '2026-09-15 19:00:00', '2026-09-15 10:00:00', 'OPEN', 'admin01', '127.0.0.1'),
  (3, '2026-09-16 19:00:00', '2026-09-16 10:00:00', 'OPEN', 'admin01', '127.0.0.1'),
  -- 임영웅 (venue=1)
  (4, '2026-10-01 18:00:00', '2026-10-01 10:00:00', 'OPEN', 'admin01', '127.0.0.1'),
  (4, '2026-10-02 18:00:00', '2026-10-02 10:00:00', 'OPEN', 'admin01', '127.0.0.1'),
  (4, '2026-10-03 15:00:00', '2026-10-03 10:00:00', 'OPEN', 'admin01', '127.0.0.1'),
  -- 뮤지컬 레미제라블 (venue=5)
  (5, '2026-08-20 19:30:00', '2026-08-20 10:00:00', 'OPEN', 'admin01', '127.0.0.1'),
  (5, '2026-08-21 19:30:00', '2026-08-21 10:00:00', 'OPEN', 'admin01', '127.0.0.1'),
  (5, '2026-08-22 14:00:00', '2026-08-22 10:00:00', 'OPEN', 'admin01', '127.0.0.1'),
  -- 세븐틴 (venue=2)
  (6, '2026-09-05 18:00:00', '2026-09-05 10:00:00', 'OPEN', 'admin01', '127.0.0.1'),
  (6, '2026-09-06 15:00:00', '2026-09-06 10:00:00', 'OPEN', 'admin01', '127.0.0.1'),
  -- NewJeans (venue=3)
  (7, '2026-08-30 17:00:00', '2026-08-30 10:00:00', 'OPEN', 'admin01', '127.0.0.1'),
  (7, '2026-08-31 17:00:00', '2026-08-31 10:00:00', 'OPEN', 'admin01', '127.0.0.1'),
  -- 나훈아 (venue=4)
  (8, '2026-10-10 19:00:00', '2026-10-10 10:00:00', 'OPEN', 'admin01', '127.0.0.1'),
  (8, '2026-10-11 17:00:00', '2026-10-11 10:00:00', 'OPEN', 'admin01', '127.0.0.1'),
  -- 뮤지컬 오페라의 유령 (venue=5)
  (9, '2026-09-10 19:30:00', '2026-09-10 10:00:00', 'OPEN', 'admin01', '127.0.0.1'),
  (9, '2026-09-11 19:30:00', '2026-09-11 10:00:00', 'OPEN', 'admin01', '127.0.0.1'),
  (9, '2026-09-12 14:00:00', '2026-09-12 10:00:00', 'OPEN', 'admin01', '127.0.0.1'),
  -- 태연 (venue=6)
  (10, '2026-11-01 19:00:00', '2026-11-01 10:00:00', 'OPEN', 'admin01', '127.0.0.1'),
  (10, '2026-11-02 17:00:00', '2026-11-02 10:00:00', 'OPEN', 'admin01', '127.0.0.1'),
  ...
  (5, '2026-08-06 19:30:00', '2026-08-06 10:00:00', 'OPEN', 'admin01', '127.0.0.1'),
  (5, '2026-08-07 19:30:00', '2026-08-07 10:00:00', 'OPEN', 'admin01', '127.0.0.1'),
  (5, '2026-08-13 19:30:00', '2026-08-13 10:00:00', 'OPEN', 'admin01', '127.0.0.1'),
  (5, '2026-08-14 19:30:00', '2026-08-14 10:00:00', 'OPEN', 'admin01', '127.0.0.1'),
  (5, '2026-08-22 19:00:00', '2026-08-22 10:00:00', 'OPEN', 'admin01', '127.0.0.1'), -- 8/22 하루 2회차(마티네+저녁)
  (5, '2026-08-27 19:30:00', '2026-08-27 10:00:00', 'OPEN', 'admin01', '127.0.0.1'),
  (5, '2026-08-28 19:30:00', '2026-08-28 10:00:00', 'OPEN', 'admin01', '127.0.0.1'),
  (5, '2026-09-03 19:30:00', '2026-09-03 10:00:00', 'OPEN', 'admin01', '127.0.0.1'),
  (5, '2026-09-04 19:30:00', '2026-09-04 10:00:00', 'OPEN', 'admin01', '127.0.0.1'),
  -- 오페라의 유령(9): 기존 9/10~12 + 아래 5회차 = 총 8회차, 9월→10월 달 이동 확인용
  (9, '2026-09-17 19:30:00', '2026-09-17 10:00:00', 'OPEN', 'admin01', '127.0.0.1'),
  (9, '2026-09-18 19:30:00', '2026-09-18 10:00:00', 'OPEN', 'admin01', '127.0.0.1'),
  (9, '2026-09-19 14:00:00', '2026-09-19 10:00:00', 'OPEN', 'admin01', '127.0.0.1'),
  (9, '2026-10-01 19:30:00', '2026-10-01 10:00:00', 'OPEN', 'admin01', '127.0.0.1'),
  (9, '2026-10-02 19:30:00', '2026-10-02 10:00:00', 'OPEN', 'admin01', '127.0.0.1');
...
INSERT INTO PROGRAMS (program_nm, url_path, program_type, ins_id, ins_ip) VALUES
  ...
  ('예매 활동 로그','/admin/reservation-history','MENU', 'SYSTEM', '127.0.0.1');
...
WHERE (p.url_path IN ('/', '/mypage'))                                    -- 전체 role 공통
   ...
   OR (p.url_path IN ('/admin/users', '/admin/programs', '/admin/menus', '/admin/categories', '/admin/reservation-history') AND r.role_id = 3);  -- 관리자만
...
INSERT INTO MENUS (program_id, parent_menu_id, menu_nm, sort_order, ins_id, ins_ip)
SELECT p.program_id, m.menu_id, '예매 활동 로그', 5, 'SYSTEM', '127.0.0.1'
FROM PROGRAMS p, MENUS m WHERE p.url_path = '/admin/reservation-history' AND m.menu_nm = '관리자';
